/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false src/worker-configuration.d.ts` (hash: 2bbb264ecb26fb9b845c43d607b9c143)
// Runtime types generated with workerd@1.20260921.1 2026-09-22 nodejs_compat
interface __BaseEnv_Env {
	BROWSE_CDP_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BROWSE_CDP_URL" | "BROWSE_PROVIDER" | "MCP_ENDPOINT">> {}
}
declare module "*.wasm" {
